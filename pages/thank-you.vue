...
useHead(() => ({
  title: computed(() => `${t('thankyou.pageTitle')} | AIToolSite`),
  meta: [
    ...
    { name: 'twitter:image', content: 'https://aitoolsite.com/thankyou_summary_image.jpeg' },
    ...
    { property: 'og:image', content: 'https://aitoolsite.com/thankyou_summary_image.jpeg' },
    { property: 'og:url', content: 'https://aitoolsite.com/thank-you' },
  ...
  link: [
    { rel: 'canonical', href: 'https://aitoolsite.com/thank-you' }
  ]
}))
